...
def chat_completion(prompt):
    message = client.messages.create(
        ...
        tools=[
            {
                "name": "generate_solidity_example",
                "description": "Generate Solidity code examples including an attack example, vulnerable code, and a fixed version.",
                "input_schema": {
                    "type": "object",
                    "properties": {
                        "attack_code": {
                            "type": "string",
                            "description": "A Solidity example showcasing an attack vector, such as reentrancy.",
                        },
                        "vulnerability_code": {
                            "type": "string",
                            "description": "A Solidity contract containing a vulnerability that could be exploited.",
                        },
                        "fixed_code": {
                            "type": "string",
                            "description": "A corrected version of the Solidity contract with the vulnerability patched.",
                        },
                    },
                    "required": ["attack_code", "vulnerability_code", "fixed_code"],
                },
            }
        ],
        tool_choice={"type": "tool", "name": "generate_solidity_example"},
        messages=[
            {
                "role": "user",
                "content": [
    ...
    return SolidityCodeExample(**message.content[0].input)
